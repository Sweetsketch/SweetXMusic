...
from SweetXMusic import Telegram, YouTube, app
from SweetXMusic.misc import SUDOERS, _boot_
from SweetXMusic.plugins.playlist import del_plist_msg
from SweetXMusic.plugins.sudoers import sudoers_list
from SweetXMusic.utils.database import (add_served_chat,
                                       add_served_user,
                                       get_served_chats,
                                       get_served_users,
                                       blacklisted_chats,
...
from SweetXMusic.utils.decorators.language import LanguageStart
from SweetXMusic.utils.formatters import get_readable_time
from SweetXMusic.utils.inline import (help_pannel, private_panel,
                                     start_pannel)
        ...
        if name[0:3] == "sta":
            ...
            def get_stats():
                ...
                for vidid, count in list_arranged.items():
                    ...
                    if vidid == "telegram":
                        msg += f"🔗[ᴛᴇʟᴇɢʀᴀᴍ ᴍᴇᴅɪᴀ](https://t.me/the_love_chat) ** ᴩʟᴀʏᴇᴅ {count} ᴛɪᴍᴇs**\n\n"
                    else:
            ...
            key = InlineKeyboardMarkup(
                [
                    [
                        ...
                        InlineKeyboardButton(
                            text="• sᴜᴩᴩᴏʀᴛ •", url="https://t.me/the_love_chat"
                        ),
                    ],
                ]
            )
